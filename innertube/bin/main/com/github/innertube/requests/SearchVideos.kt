 ...
 * Returns a list of VideoItems.
 */
suspend fun searchVideos(query: String): Result<Innertube.ItemsPage<Innertube.VideoItem>>? = runCatchingNonCancellable {
    ...
    Innertube.ItemsPage(
        items = musicShelfRenderer?.contents?.mapNotNull { Innertube.VideoItem.from(it) },
